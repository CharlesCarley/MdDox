...
It needs to be defined somewhere in the project's source code comments
as \c \\mainpage.

In this implementation its use is required.
The reason for this is it keeps things simple and customizable because it allows
descriptions to lead into key areas first, before presenting the index.
