...
namespace MdDox
{
    ...
    public:
        ...
        /**
         * \brief Abstract method, derived scanners should implement their own
         * scan loop.
         * \param tok A reference to a temporary storage token.  
         *
         */
        virtual void scan(TokenBase& tok) = 0;

        /**
         * \brief Attaches an input stream to this scanner, resets the line count,
         * and assigns a file name for error reporting.
         *  
         * \param stream The input stream to attach.
         * \param file A name for the stream. 
         */
