...
{
    /**
     * \brief Enum for adding specific background and foreground colors to the console
     */
    enum ConsoleColor
    {
        CS_BLACK = 0,
    ...
    /**
     * \brief Utility console class.
     *
     * Makes use of cout, cin and cerr.
     */
    class Console
    {
    public:
        ...
        /**
         * \brief Writes the contents of the supplied stream to stdout followed by a line ending.
         * \param str The content to write.
         */
        static void writeLine(const OutputStringStream& str);

        /**
         * \brief Writes the contents of the supplied stream to stderr.
         * \param str The content to write.
         */
        static void writeError(const OutputStringStream& str);

        /**
         * \brief Breaks the current debugging process in Visual Studio.
         */
