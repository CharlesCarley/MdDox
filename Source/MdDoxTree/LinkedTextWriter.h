...
namespace MdDox
{
    ...
    class LinkedTextWriter final : public Doxygen::Visitors::LinkedTextQueryVisitor
    {
    private:
    ...
    public:
        LinkedTextWriter(DocumentWriter* writer, OStream* out);

        bool write(const Doxygen::LinkedTextQuery& query);
    };
