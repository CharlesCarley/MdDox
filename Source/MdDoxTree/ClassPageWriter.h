...
namespace MdDox
{
	...
	class ClassPageWriter final : public PageWriter
    {
    private:
        bool _baseInit{false};
        bool _deriveInit{false};
    ...
    public:
        ClassPageWriter(DocumentWriter* writer, const Reference& ref, const PathUtil& out);

		~ClassPageWriter() override = default;
    };
