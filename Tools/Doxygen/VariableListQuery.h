...
namespace MdDox::Doxygen
{
    ...
    /**
     * \brief Implements the <tt>docVariableListType</tt> scaffolding.
     *
     * The following xml provides the source for the <b>docVariableListType</b> 
     * scaffolding.
     *
     * \code{.xml}
    ...
    public:
        ...
        explicit VariableListQuery(Xml::Node* node) :
            _node(node)
        {
        }

        VariableListQuery(const VariableListQuery& other) = default;
    ...
    inline bool VariableListQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void VariableListQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* VariableListQuery::node() const
    {
        return _node;
    }

    inline bool VariableListQuery::empty() const
    {
