...
namespace MdDox::Doxygen
{
    ...
    inline bool DescriptionQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void DescriptionQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* DescriptionQuery::node() const
    {
        return _node;
    }

    inline bool DescriptionQuery::empty() const
    {
