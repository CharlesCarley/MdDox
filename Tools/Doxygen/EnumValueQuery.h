...
namespace MdDox::Doxygen
{
    ...
    inline bool EnumValueQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void EnumValueQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* EnumValueQuery::node() const
    {
        return _node;
    }

    inline bool EnumValueQuery::empty() const
    {
