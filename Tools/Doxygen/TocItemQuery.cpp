...
{
    void TocItemQuery::visit(Visitors::TocItemQueryVisitor *visitor) const
    {
        if (!_node || !visitor)
            return;
    ...
    const String& TocItemQuery::getId(const String& notFound) const
    {
        if (_node)
    ...
    const String& TocItemQuery::getDot(const String& notFound) const
    {
        if (_node) {
	...
	void TocItemQuery::getULink(UrlLinkQuery &dest) const
	{
		if (_node) {
	...
	UrlLinkQuery TocItemQuery::getULink() const
	{
		UrlLinkQuery dest;
		getULink(dest);
		return dest;
	...
	void TocItemQuery::getBold(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery TocItemQuery::getBold() const
	{
		MarkupQuery dest;
		getBold(dest);
		return dest;
	...
	void TocItemQuery::getEmphasis(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery TocItemQuery::getEmphasis() const
	{
		MarkupQuery dest;
		getEmphasis(dest);
		return dest;
	...
	void TocItemQuery::getComputerOutput(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery TocItemQuery::getComputerOutput() const
	{
		MarkupQuery dest;
	...
	void TocItemQuery::getCenter(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery TocItemQuery::getCenter() const
	{
		MarkupQuery dest;
		getCenter(dest);
		return dest;
	...
	void TocItemQuery::getSmall(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery TocItemQuery::getSmall() const
	{
		MarkupQuery dest;
		getSmall(dest);
		return dest;
	...
	void TocItemQuery::getAnchor(AnchorQuery &dest) const
	{
		if (_node) {
	...
	AnchorQuery TocItemQuery::getAnchor() const
	{
		AnchorQuery dest;
		getAnchor(dest);
		return dest;
	...
	void TocItemQuery::getRef(RefTextQuery &dest) const
	{
		if (_node) {
	...
	RefTextQuery TocItemQuery::getRef() const
	{
		RefTextQuery dest;
		getRef(dest);
		return dest;
	...
	void TocItemQuery::getSect(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery TocItemQuery::getSect() const
	{
		EmptyQuery dest;
		getSect(dest);
		return dest;
	...
	void TocItemQuery::getRegistered(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery TocItemQuery::getRegistered() const
	{
		EmptyQuery dest;
		getRegistered(dest);
		return dest;
	...
	void TocItemQuery::getParagraph(ParaQuery &dest) const
	{
		if (_node) {
	...
	ParaQuery TocItemQuery::getParagraph() const
	{
		ParaQuery dest;
		getParagraph(dest);
		return dest;
	...
	void TocItemQuery::getPart(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery TocItemQuery::getPart() const
	{
		EmptyQuery dest;
		getPart(dest);
		return dest;
	...
	void TocItemQuery::getProp(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery TocItemQuery::getProp() const
	{
		EmptyQuery dest;
		getProp(dest);
		return dest;
	...
	void TocItemQuery::getLang(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery TocItemQuery::getLang() const
	{
		EmptyQuery dest;
		getLang(dest);
		return dest;
    ...
    const String& TocItemQuery::text(const String &def) const
    {
        return _node ? _node->text() : def;
    }
    
    void TocItemQuery::sort(const SortMap& childOrder) const
    {
        if (_node) {
            _node->sort(
