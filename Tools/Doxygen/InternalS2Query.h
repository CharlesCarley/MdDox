...
namespace MdDox::Doxygen
{
    namespace Visitors
    {
        class InternalS2QueryVisitor
        {
        public:
            virtual ~InternalS2QueryVisitor() = default;
    ...
    /**
     * \brief Implements the <tt>docInternalS2Type</tt> scaffolding.
     *
     * The following xml provides the source for the <b>docInternalS2Type</b> 
     * scaffolding.
     *
     * \code{.xml}
    ...
    public:
        ...
        explicit InternalS2Query(Xml::Node* node) :
            _node(node)
        {
        }

        InternalS2Query(const InternalS2Query& other) = default;
        ...
        void visit(Visitors::InternalS2QueryVisitor *) const;
        /**
    ...
    inline bool InternalS2Query::isValid() const
    {
        return _node != nullptr;
    }

    inline void InternalS2Query::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* InternalS2Query::node() const
    {
        return _node;
    }

    inline bool InternalS2Query::empty() const
    {
