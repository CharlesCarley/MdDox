...
namespace MdDox::Doxygen
{
    ...
    /**
     * \brief Implements the <tt>docFormulaType</tt> scaffolding.
     *
     * The following xml provides the source for the <b>docFormulaType</b> 
     * scaffolding.
     *
     * \code{.xml}
    ...
    public:
        ...
        explicit FormulaQuery(Xml::Node* node) :
            _node(node)
        {
        }

        FormulaQuery(const FormulaQuery& other) = default;
    ...
    inline bool FormulaQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void FormulaQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* FormulaQuery::node() const
    {
        return _node;
    }

    inline bool FormulaQuery::empty() const
    {
