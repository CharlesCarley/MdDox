...
#include "DoxImageKind.h"

namespace MdDox::Doxygen
{
    namespace Visitors
    {
        class ImageQueryVisitor
        {
        public:
            virtual ~ImageQueryVisitor() = default;
    ...
    /**
     * \brief Implements the <tt>docImageType</tt> scaffolding.
     *
    ...
    public:
        ...
        explicit ImageQuery(Xml::Node* node) :
            _node(node)
        {
        }

        ImageQuery(const ImageQuery& other) = default;
        ...
        void visit(Visitors::ImageQueryVisitor *) const;
        /**
         * \brief Provides access to the <b>type</b> element.
         *
         * \return The <b>type</b> enumerated value or -1 if the value is not found. 
         */
        DoxImageKindEnum getType() const;
        ...
        /**
         * \brief Provides access to the <b>width</b> attribute.
         *
         * \return The <b>width</b> enumerated value or an empty string 
         *  the value is not found. 
         */
        const String& getWidth(const String& notFound="") const;

        /**
         * \brief Provides access to the <b>height</b> attribute.
         *
         * \return The <b>height</b> enumerated value or an empty string 
         *  the value is not found. 
         */
        const String& getHeight(const String& notFound="") const;
    ...
    inline bool ImageQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void ImageQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* ImageQuery::node() const
    {
        return _node;
    }

    inline bool ImageQuery::empty() const
    {
