...
namespace MdDox::Doxygen
{
    namespace Visitors
    {
        class TitleQueryVisitor
        {
        public:
            virtual ~TitleQueryVisitor() = default;
    ...
    /**
     * \brief Implements the <tt>docTitleType</tt> scaffolding.
     *
     * The following xml provides the source for the <b>docTitleType</b> 
     * scaffolding.
     *
     * \code{.xml}
    ...
    public:
        ...
        explicit TitleQuery(Xml::Node* node) :
            _node(node)
        {
        }

        TitleQuery(const TitleQuery& other) = default;
        ...
        void visit(Visitors::TitleQueryVisitor *) const;
        /**
    ...
    inline bool TitleQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void TitleQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* TitleQuery::node() const
    {
        return _node;
    }

    inline bool TitleQuery::empty() const
    {
