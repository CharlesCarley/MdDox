...
namespace MdDox::Doxygen
{
    ...
    inline bool ChildNodeQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void ChildNodeQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* ChildNodeQuery::node() const
    {
        return _node;
    }

    inline bool ChildNodeQuery::empty() const
    {
