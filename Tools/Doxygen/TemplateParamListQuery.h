...
namespace MdDox::Doxygen
{
    ...
    inline bool TemplateParamListQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void TemplateParamListQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* TemplateParamListQuery::node() const
    {
        return _node;
    }

    inline bool TemplateParamListQuery::empty() const
    {
