...
{
    void HeadingQuery::visit(Visitors::HeadingQueryVisitor *visitor) const
    {
        if (!_node || !visitor)
            return;
    ...
    int64_t HeadingQuery::getLevel(int64_t def) const
    {
        return _node ? _node->integer("level") : def;
    }

    const String& HeadingQuery::getDot(const String& notFound) const
    {
        if (_node) {
	...
	void HeadingQuery::getULink(UrlLinkQuery &dest) const
	{
		if (_node) {
	...
	UrlLinkQuery HeadingQuery::getULink() const
	{
		UrlLinkQuery dest;
		getULink(dest);
		return dest;
	...
	void HeadingQuery::getBold(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery HeadingQuery::getBold() const
	{
		MarkupQuery dest;
		getBold(dest);
		return dest;
	...
	void HeadingQuery::getEmphasis(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery HeadingQuery::getEmphasis() const
	{
		MarkupQuery dest;
		getEmphasis(dest);
		return dest;
	...
	void HeadingQuery::getComputerOutput(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery HeadingQuery::getComputerOutput() const
	{
		MarkupQuery dest;
	...
	void HeadingQuery::getCenter(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery HeadingQuery::getCenter() const
	{
		MarkupQuery dest;
		getCenter(dest);
		return dest;
	...
	void HeadingQuery::getSmall(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery HeadingQuery::getSmall() const
	{
		MarkupQuery dest;
		getSmall(dest);
		return dest;
	...
	void HeadingQuery::getAnchor(AnchorQuery &dest) const
	{
		if (_node) {
	...
	AnchorQuery HeadingQuery::getAnchor() const
	{
		AnchorQuery dest;
		getAnchor(dest);
		return dest;
	...
	void HeadingQuery::getRef(RefTextQuery &dest) const
	{
		if (_node) {
	...
	RefTextQuery HeadingQuery::getRef() const
	{
		RefTextQuery dest;
		getRef(dest);
		return dest;
	...
	void HeadingQuery::getSect(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery HeadingQuery::getSect() const
	{
		EmptyQuery dest;
		getSect(dest);
		return dest;
	...
	void HeadingQuery::getRegistered(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery HeadingQuery::getRegistered() const
	{
		EmptyQuery dest;
		getRegistered(dest);
		return dest;
	...
	void HeadingQuery::getParagraph(ParaQuery &dest) const
	{
		if (_node) {
	...
	ParaQuery HeadingQuery::getParagraph() const
	{
		ParaQuery dest;
		getParagraph(dest);
		return dest;
	...
	void HeadingQuery::getPart(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery HeadingQuery::getPart() const
	{
		EmptyQuery dest;
		getPart(dest);
		return dest;
	...
	void HeadingQuery::getProp(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery HeadingQuery::getProp() const
	{
		EmptyQuery dest;
		getProp(dest);
		return dest;
	...
	void HeadingQuery::getLang(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery HeadingQuery::getLang() const
	{
		EmptyQuery dest;
		getLang(dest);
		return dest;
    ...
    const String& HeadingQuery::text(const String &def) const
    {
        return _node ? _node->text() : def;
    }
    
    void HeadingQuery::sort(const SortMap& childOrder) const
    {
        if (_node) {
            _node->sort(
