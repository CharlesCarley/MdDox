...
{
    void CaptionQuery::visit(Visitors::CaptionQueryVisitor *visitor) const
    {
        if (!_node || !visitor)
            return;
    ...
    const String& CaptionQuery::getDot(const String& notFound) const
    {
        if (_node) {
	...
	void CaptionQuery::getULink(UrlLinkQuery &dest) const
	{
		if (_node) {
	...
	UrlLinkQuery CaptionQuery::getULink() const
	{
		UrlLinkQuery dest;
		getULink(dest);
		return dest;
	...
	void CaptionQuery::getBold(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery CaptionQuery::getBold() const
	{
		MarkupQuery dest;
		getBold(dest);
		return dest;
	...
	void CaptionQuery::getEmphasis(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery CaptionQuery::getEmphasis() const
	{
		MarkupQuery dest;
		getEmphasis(dest);
		return dest;
	...
	void CaptionQuery::getComputerOutput(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery CaptionQuery::getComputerOutput() const
	{
		MarkupQuery dest;
	...
	void CaptionQuery::getCenter(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery CaptionQuery::getCenter() const
	{
		MarkupQuery dest;
		getCenter(dest);
		return dest;
	...
	void CaptionQuery::getSmall(MarkupQuery &dest) const
	{
		if (_node) {
	...
	MarkupQuery CaptionQuery::getSmall() const
	{
		MarkupQuery dest;
		getSmall(dest);
		return dest;
	...
	void CaptionQuery::getAnchor(AnchorQuery &dest) const
	{
		if (_node) {
	...
	AnchorQuery CaptionQuery::getAnchor() const
	{
		AnchorQuery dest;
		getAnchor(dest);
		return dest;
	...
	void CaptionQuery::getRef(RefTextQuery &dest) const
	{
		if (_node) {
	...
	RefTextQuery CaptionQuery::getRef() const
	{
		RefTextQuery dest;
		getRef(dest);
		return dest;
	...
	void CaptionQuery::getSect(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery CaptionQuery::getSect() const
	{
		EmptyQuery dest;
		getSect(dest);
		return dest;
	...
	void CaptionQuery::getRegistered(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery CaptionQuery::getRegistered() const
	{
		EmptyQuery dest;
		getRegistered(dest);
		return dest;
	...
	void CaptionQuery::getParagraph(ParaQuery &dest) const
	{
		if (_node) {
	...
	ParaQuery CaptionQuery::getParagraph() const
	{
		ParaQuery dest;
		getParagraph(dest);
		return dest;
	...
	void CaptionQuery::getPart(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery CaptionQuery::getPart() const
	{
		EmptyQuery dest;
		getPart(dest);
		return dest;
	...
	void CaptionQuery::getProp(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery CaptionQuery::getProp() const
	{
		EmptyQuery dest;
		getProp(dest);
		return dest;
	...
	void CaptionQuery::getLang(EmptyQuery &dest) const
	{
		if (_node) {
	...
	EmptyQuery CaptionQuery::getLang() const
	{
		EmptyQuery dest;
		getLang(dest);
		return dest;
    ...
    const String& CaptionQuery::text(const String &def) const
    {
        return _node ? _node->text() : def;
    }
    
    void CaptionQuery::sort(const SortMap& childOrder) const
    {
        if (_node) {
            _node->sort(
