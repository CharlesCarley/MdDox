...
namespace MdDox::Doxygen
{
    namespace Visitors
    {
        class CaptionQueryVisitor
        {
        public:
            virtual ~CaptionQueryVisitor() = default;
    ...
    /**
     * \brief Implements the <tt>docCaptionType</tt> scaffolding.
     *
    ...
    public:
        ...
        explicit CaptionQuery(Xml::Node* node) :
            _node(node)
        {
        }

        CaptionQuery(const CaptionQuery& other) = default;
        ...
        void visit(Visitors::CaptionQueryVisitor *) const;
        /**
    ...
    inline bool CaptionQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void CaptionQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* CaptionQuery::node() const
    {
        return _node;
    }

    inline bool CaptionQuery::empty() const
    {
