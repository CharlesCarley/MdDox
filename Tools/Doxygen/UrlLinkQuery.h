...
namespace MdDox::Doxygen
{
    namespace Visitors
    {
        class UrlLinkQueryVisitor
        {
        public:
            virtual ~UrlLinkQueryVisitor() = default;
    ...
    /**
     * \brief Implements the <tt>docURLLink</tt> scaffolding.
     *
     * The following xml provides the source for the <b>docURLLink</b> 
     * scaffolding.
     *
     * \code{.xml}
    ...
    public:
        ...
        explicit UrlLinkQuery(Xml::Node* node) :
            _node(node)
        {
        }

        UrlLinkQuery(const UrlLinkQuery& other) = default;
        ...
        void visit(Visitors::UrlLinkQueryVisitor *) const;
        /**
         * \brief Provides access to the <b>url</b> attribute.
         *
         * \return The <b>url</b> enumerated value or an empty string 
         *  the value is not found. 
         */
        const String& getUrl(const String& notFound="") const;
    ...
    inline bool UrlLinkQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void UrlLinkQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* UrlLinkQuery::node() const
    {
        return _node;
    }

    inline bool UrlLinkQuery::empty() const
    {
