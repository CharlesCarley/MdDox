...
namespace MdDox::Doxygen
{
    ...
    inline bool DoxygenIndexQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void DoxygenIndexQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* DoxygenIndexQuery::node() const
    {
        return _node;
    }

    inline bool DoxygenIndexQuery::empty() const
    {
