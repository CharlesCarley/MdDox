...
namespace MdDox::Doxygen
{
    ...
    inline bool HighlightQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void HighlightQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* HighlightQuery::node() const
    {
        return _node;
    }

    inline bool HighlightQuery::empty() const
    {
