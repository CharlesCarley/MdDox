...
namespace MdDox::Doxygen
{
    ...
    inline bool MemberIndexQuery::isValid() const
    {
        return _node != nullptr;
    }

    inline void MemberIndexQuery::reset()
    {
        _node = nullptr;
    }

    inline Xml::Node* MemberIndexQuery::node() const
    {
        return _node;
    }

    inline bool MemberIndexQuery::empty() const
    {
