...
namespace MdDox::Doxygen
{
    namespace Visitors
    {
        class ParaQueryVisitor
        {
        public:
            virtual ~ParaQueryVisitor() = default;
    ...
    /**
     * \brief Implements the <tt>docParaType</tt> scaffolding.
     *
     * The following xml provides the source for the <b>docParaType</b> 
     * scaffolding.
     *
     * \code{.xml}
